...
import { Search, LogOut, Home, Lightbulb, Users, Award, FileText, Settings, PieChart, TrendingUp, MessageSquare, Calendar, Lock, ChevronLeft, ChevronRight } from 'lucide-react';
import "./Sidebar.css";
...
const Sidebar = ({ activeMenuItem, setActiveMenuItem }) => {
  ...
  const menuItems = [
    ...
    { name: "Manage Ideas", icon: Lightbulb, path: "/dashboard/manage-ideas" },
    { name: "Manage Users", icon: Users, path: "/dashboard/manage-users" },
    { name: "Our Leadership", icon: Award, path: "/dashboard/leadership" },
    { name: "Latest News & Events", icon: FileText, path: "/dashboard/news-events" },
  ...
  const additionalMenuItems = [
    ...
    { name: "Security", icon: Lock, path: "/dashboard/security" },
  ];
    ...
    <>
      ...
      >
        <div className="d-flex align-items-center justify-content-between p-3 border-bottom">
          ...
          <button className="btn btn-sm btn-light d-none d-md-flex" onClick={toggleSidebar}>
        ...
        <nav className="mt-2 overflow-auto">
          {menuItems.map((item) => (
            <Link
              ...
              onClick={(e) => {
                e.preventDefault(); // Prevent actual navigation in this demo
          ...
          {sidebarExpanded && <div className="px-3 py-2 small text-muted">ADDITIONAL FEATURES</div>}
        ...
        <div className="mt-auto p-3 border-top">
          ...
          <Link
            ...
            onClick={(e) => e.preventDefault()} // Prevent actual navigation in this demo
          >
            <LogOut size={18} />
