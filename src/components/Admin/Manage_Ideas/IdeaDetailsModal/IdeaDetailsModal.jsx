          ...
          <div className="row mb-4">
            ...
            <div className="col-md-6 mb-3">
              <div className="info-card">
                ...
                <div className="info-card-content">
                  <h6 className="info-card-label">Funding Required</h6>
                  <p className="info-card-value">${selectedIdea.fundingRequired?.toLocaleString()}</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6 mb-3">
              <div className="info-card">
                ...
                <div className="info-card-content">
                  <h6 className="info-card-label">Stage</h6>
                  <p className="info-card-value">{selectedIdea.stage}</p>
                </div>
              </div>
            </div>
          </div>
