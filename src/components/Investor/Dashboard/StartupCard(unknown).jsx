...
const StartupCard_unknown = ({ startup, onViewDetails }) => {
    ...
    <div className="startup-card">
      <div className="startup-image-container">
        ...
        <div className="startup-status">
          <span className={`status-badge ${getStatusClass(startup.status)}`}>{startup.status}</span>
        </div>
      </div>
        ...
        <div className="startup-info">
          <div className="startup-header">
            ...
            <p className="startup-founder">
              Founder: <span className="founder-name">{startup.entrepreneur}</span>
            </p>
          </div>
          ...
          <button className="view-details-button" onClick={() => onViewDetails(startup)}>
...
export default StartupCard_unknown
